...
<header>
	<div class="logo_wrap">
		<a href="/pro02"><img src="${hpath }/images/logo.png" alt="해운대 로고" /></a>
	</div>
	<div id="tnb" style="height:100px; line-height:5rem; padding-top:2rem">
		<c:if test="${not empty sid }">
		<h2 style="float:right;">${sid } 님 환영합니다.</h2>
		</c:if>
		<c:if test="${empty sid }">
		<h2 style="text-align:center;">해운대구 소개에 오신 것을 환영합니다.</h2>
		</c:if>
	</div>
	<nav id="gnb">
		<ul class="">
			...
			<li class="item">
				...
				<ul class="sub_menu">
					...
					<li><a href="${hpath }/tour/hotel.jsp">호텔 안내</a></li>
				</ul>
			</li>
			<li class="item">
